...
## Real-Gas Behavior (Compressibility Factor)
...
1.  **Sonic (Choked) Flow**: The gas is moving at the speed of sound.
    ...
    - Increasing downstream pressure _does not_ reduce the flow rate until it rises above a critical point.
...
## Thermodynamic Effects (Heating & Cooling)
