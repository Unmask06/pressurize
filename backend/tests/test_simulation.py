...
class TestDualVesselModes:
    """Test suite for dual-vessel modes: pressurize, depressurize, and equalize."""
    ...
    def test_pressurize_mode_upstream_constant(self):
        ...
        df = run_simulation(
            ...
            P_down_init_psig=0,
            volume_ft3=100,
            upstream_volume_ft3=200,  # Large upstream volume
    ...
    def test_depressurize_mode_downstream_constant(self):
        ...
        df = run_simulation(
            ...
            downstream_volume_ft3=200,  # Large downstream volume
            valve_id_inch=2,
            opening_time_s=5,
            temp_f=70,
            molar_mass=29,
    ...
    def test_equalize_mode_both_evolve(self):
        ...
        assert downstream_pressures[-1] != downstream_pressures[0], (
            "Downstream pressure should evolve in equalize mode"
        )

        # They should approach each other
        initial_diff = abs(upstream_pressures[0] - downstream_pressures[0])
        final_diff = abs(upstream_pressures[-1] - downstream_pressures[-1])
        assert final_diff < initial_diff, "Pressures should converge in equalize mode"
